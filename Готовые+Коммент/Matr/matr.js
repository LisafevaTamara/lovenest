    ...
    if(code == 'encode'){       // проверка на действие (в даннос случае это зашифровка, выбран 'encode')
     ...
     if(code=='decode'){        // проверка на действие (в даннос случае это расшифровка, выбран 'decode')
         ...
         for(let i = 0; i<textnew2.length;i++){ // цикл повторяющийся такое количество раз, равное длинне текста
            ...
            textza += alf[matrnew[0][0] * matrnum[0][0] + matrnew[0][1] * matrnum[1][0] + matrnew[0][2] * matrnum[2][0]]; // производим умножение матриц, и записываем полученное число в результат
            textza += alf[matrnew[1][0] * matrnum[0][0] + matrnew[1][1] * matrnum[1][0] + matrnew[1][2] * matrnum[2][0]]; // производим умножение матриц, и записываем полученное число в результат
            textza += alf[matrnew[2][0] * matrnum[0][0] + matrnew[2][1] * matrnum[1][0] + matrnew[2][2] * matrnum[2][0]]; // производим умножение матриц, и записываем полученное число в результат
