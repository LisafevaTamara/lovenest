...
proverb = "Заяц в кустах - это еще не готовое мясо."
proverb = proverb.replace(" ", "")
proverb = proverb.lower()
while proverb.find(",") != -1: #заменяем все запятые на "зпт"
    str1 = proverb[:proverb.find(",")]
    str2 = proverb[proverb.find(",") + 1:]
    proverb = str1 + "зпт" + str2
while proverb.find(".") != -1: #заменяем все точки на тчк
    str1 = proverb[:proverb.find(".")]
    str2 = proverb[proverb.find(".") + 1:]
    proverb = str1 + "тчк" + str2
while proverb.find("-") != -1:  # заменяем все - на тире
    str1 = proverb[:proverb.find("-")]
    str2 = proverb[proverb.find("-") + 1:]
    proverb = str1 + "тире" + str2
