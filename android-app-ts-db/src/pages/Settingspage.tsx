...
import { ToDoItem } from '../db-services/index';
import { getDBConnection, getTodoItems, saveTodoItems, createTable, deleteTodoItem } from '../db-services/db-services';


//export default function ({navigation}: Props) {};
 export const Settingspage = () => { //работа с бд
